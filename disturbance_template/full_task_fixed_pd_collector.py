...
from disturbance_template.full_task_recording import FullTaskRawRecorder, save_smoke_plots
...
DEFAULT_OUTPUT_BASE = REPO_DIR / "disturbance_template" / "data" / "full_task_template_v1"
DEFAULT_OUTPUT_BASE_V2 = REPO_DIR / "disturbance_template" / "data" / "full_task_template_v2"
...
def _build_existing_collection(root: Path, config: dict[str, Any], config_path: Path,
    ...
    from disturbance_template.full_task_template_builder import _episode_heading_windows
