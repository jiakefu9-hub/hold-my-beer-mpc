# 怎么用
# - 使用默认输入输出路径：
#   python /home/fjk/g1_ws/hold-my-beer-mpc/build_fully_smoothed_disturbance_template.py
#
# - 指定输入模板：
#   python /home/fjk/g1_ws/hold-my-beer-mpc/build_fully_smoothed_disturbance_template.py \
...
# - 指定输出前缀：
#   python /home/fjk/g1_ws/hold-my-beer-mpc/build_fully_smoothed_disturbance_template.py \
#       --output-prefix /home/fjk/g1_ws/hold-my-beer-mpc/disturbance_template_fully_smoothed
...
def main():
    ...
    parser.add_argument(
        "--output-prefix",
        type=str,
        default="/home/fjk/g1_ws/hold-my-beer-mpc/disturbance_template_fully_smoothed",
        help="输出文件前缀",
    )
